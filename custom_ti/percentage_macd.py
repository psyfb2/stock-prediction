...
def percentage_macd(close, fast=None, slow=None, signal=None, talib=None, offset=None, **kwargs):
...
percentage_macd.__doc__ = \
"""Percentage Moving Average Convergence Divergence (MACD)
...
Calculation:
    ...
    MACD = (EMA(close, fast) - EMA(close, slow)) /  EMA(close, slow)
